  ...
  return <div className='h-full bg-primary/30'>
    <div className='container mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full'>
      <div className='flex flex-col w-full max-w-[700px]'>
        ...
        <motion.form variants={fadeIn('up',0.4)} initial="hidden" animate="show" exit="hidden" action="" className='flex-1 flex flex-col gap-6 w-full mx-auto'>
          <div className='flex gap-x-6 w-full'>
            ...
            <button className='btn rounded-full border border-white/50 max-w-[170px] px-8 tranisition-all duration-300 flex items-center justify-center overflow-hidden hover:border-accent group'>
